...
// HasSubjectScopes applies the HasEdge predicate on the "subject_scopes" edge.
func HasSubjectScopes() predicate.AttestationPolicy {
...
// HasSubjectScopesWith applies the HasEdge predicate on the "subject_scopes" edge with a given conditions (other predicates).
func HasSubjectScopesWith(preds ...predicate.SubjectScope) predicate.AttestationPolicy {
	return predicate.AttestationPolicy(func(s *sql.Selector) {
		step := newSubjectScopesStep()
