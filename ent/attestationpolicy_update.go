...
func (apu *AttestationPolicyUpdate) AddSubjectScopeIDs(ids ...int) *AttestationPolicyUpdate {
	apu.mutation.AddSubjectScopeIDs(ids...)
	return apu
}

// AddSubjectScopes adds the "subject_scopes" edges to the SubjectScope entity.
func (apu *AttestationPolicyUpdate) AddSubjectScopes(s ...*SubjectScope) *AttestationPolicyUpdate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return apu.AddSubjectScopeIDs(ids...)
}
...
// ClearSubjectScopes clears all "subject_scopes" edges to the SubjectScope entity.
func (apu *AttestationPolicyUpdate) ClearSubjectScopes() *AttestationPolicyUpdate {
	apu.mutation.ClearSubjectScopes()
	return apu
}

// RemoveSubjectScopeIDs removes the "subject_scopes" edge to SubjectScope entities by IDs.
func (apu *AttestationPolicyUpdate) RemoveSubjectScopeIDs(ids ...int) *AttestationPolicyUpdate {
	apu.mutation.RemoveSubjectScopeIDs(ids...)
	return apu
}

// RemoveSubjectScopes removes "subject_scopes" edges to SubjectScope entities.
func (apu *AttestationPolicyUpdate) RemoveSubjectScopes(s ...*SubjectScope) *AttestationPolicyUpdate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return apu.RemoveSubjectScopeIDs(ids...)
}
...
func (apu *AttestationPolicyUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if apu.mutation.SubjectScopesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   attestationpolicy.SubjectScopesTable,
			Columns: []string{attestationpolicy.SubjectScopesColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(subjectscope.FieldID, field.TypeInt),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	if nodes := apu.mutation.RemovedSubjectScopesIDs(); len(nodes) > 0 && !apu.mutation.SubjectScopesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   attestationpolicy.SubjectScopesTable,
	...
	if nodes := apu.mutation.SubjectScopesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   attestationpolicy.SubjectScopesTable,
...
// AddSubjectScopeIDs adds the "subject_scopes" edge to the SubjectScope entity by IDs.
func (apuo *AttestationPolicyUpdateOne) AddSubjectScopeIDs(ids ...int) *AttestationPolicyUpdateOne {
	apuo.mutation.AddSubjectScopeIDs(ids...)
	return apuo
}

// AddSubjectScopes adds the "subject_scopes" edges to the SubjectScope entity.
func (apuo *AttestationPolicyUpdateOne) AddSubjectScopes(s ...*SubjectScope) *AttestationPolicyUpdateOne {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return apuo.AddSubjectScopeIDs(ids...)
}
...
// ClearSubjectScopes clears all "subject_scopes" edges to the SubjectScope entity.
func (apuo *AttestationPolicyUpdateOne) ClearSubjectScopes() *AttestationPolicyUpdateOne {
	apuo.mutation.ClearSubjectScopes()
	return apuo
}

// RemoveSubjectScopeIDs removes the "subject_scopes" edge to SubjectScope entities by IDs.
func (apuo *AttestationPolicyUpdateOne) RemoveSubjectScopeIDs(ids ...int) *AttestationPolicyUpdateOne {
	apuo.mutation.RemoveSubjectScopeIDs(ids...)
	return apuo
}

// RemoveSubjectScopes removes "subject_scopes" edges to SubjectScope entities.
func (apuo *AttestationPolicyUpdateOne) RemoveSubjectScopes(s ...*SubjectScope) *AttestationPolicyUpdateOne {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return apuo.RemoveSubjectScopeIDs(ids...)
}
...
func (apuo *AttestationPolicyUpdateOne) sqlSave(ctx context.Context) (_node *AttestationPolicy, err error) {
	...
	if apuo.mutation.SubjectScopesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   attestationpolicy.SubjectScopesTable,
	...
	if nodes := apuo.mutation.RemovedSubjectScopesIDs(); len(nodes) > 0 && !apuo.mutation.SubjectScopesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   attestationpolicy.SubjectScopesTable,
	...
	if nodes := apuo.mutation.SubjectScopesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   attestationpolicy.SubjectScopesTable,
